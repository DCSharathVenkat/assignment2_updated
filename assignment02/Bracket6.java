...
public class Bracket6 extends TaxDecorator {
    int taxSlice;
    Brackets bracket = Brackets.BRACKET6;

    public Bracket6(TaxComponent delegate) {
        super(delegate);
        taxSlice = delegate.getCap(bracket) - delegate.getCap(Brackets.BRACKET5);
    }
