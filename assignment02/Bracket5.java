...
public class Bracket5 extends TaxDecorator {
    int taxSlice;
    Brackets bracket = Brackets.BRACKET5;

    public Bracket5(TaxComponent delegate) {
        super(delegate);
        taxSlice = delegate.getCap(bracket) - delegate.getCap(Brackets.BRACKET4);
    }
